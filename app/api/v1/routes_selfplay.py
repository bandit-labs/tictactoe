...
class SelfPlayRequest(BaseModel):
    num_games: int = Field(default=100, ge=1, le=10000, description="Number of games to play")
    ...
    alternate_starting_player: bool = Field(default=True, description="Alternate X/O each game")
...
def list_self_play_jobs():
    ...
    return [
        ...
        for job_id, job_data in self_play_jobs.items()
    ]