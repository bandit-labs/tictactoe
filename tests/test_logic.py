...
from app.domain.logic import legal_moves, apply_move, _compute_winner, board_to_string, board_from_string, heuristic_value

# --- GameState.new() Test ---
def test_new_game_state():
    """Test creating a new game state."""
    state = GameState.new()
    assert state.board == [[Mark.EMPTY, Mark.EMPTY, Mark.EMPTY],
...
def test_legal_moves_initial():
    ...
    expected_moves = [(0, 0), (0, 1), (0, 2), (1, 0), (1, 1), (1, 2), (2, 0), (2, 1), (2, 2)]
...
def test_apply_move_success():
    ...
    expected_board = [[Mark.EMPTY, Mark.EMPTY, Mark.EMPTY],
...
def test_apply_move_win_row():
    ...
    state = GameState(
        board=[[Mark.X, Mark.X, Mark.EMPTY],
...
def test_apply_move_win_col():
    ...
    # . . .
    state = GameState(
        board=[[Mark.X, Mark.O, Mark.EMPTY],
               [Mark.O, Mark.O, Mark.EMPTY], # O has (1,1)
               [Mark.EMPTY, Mark.EMPTY, Mark.EMPTY]], # O needs (2,1) to win column 1
...
def test_apply_move_win_diag():
    ...
    state = GameState(
        board=[[Mark.X, Mark.EMPTY, Mark.EMPTY],
               ...
               [Mark.EMPTY, Mark.EMPTY, Mark.EMPTY]], # X needs (2,2) to win main diagonal
...
def test_apply_move_draw():
    ...
    state = GameState(
        board=[[Mark.X, Mark.O, Mark.X],
               [Mark.O, Mark.X, Mark.O],
               [Mark.O, Mark.X, Mark.EMPTY]], # 8 moves played
        next_player=Mark.O,
        status=GameStatus.IN_PROGRESS,
        winner=None,
        move_count=8
...
def test_compute_winner_row():
    ...
    board_x_win = [[Mark.X, Mark.X, Mark.X],
                   [Mark.O, Mark.EMPTY, Mark.O],
                   [Mark.O, Mark.EMPTY, Mark.EMPTY]]
    assert _compute_winner(board_x_win) == Mark.X

    board_o_win = [[Mark.O, Mark.EMPTY, Mark.EMPTY],
...
def test_compute_winner_col():
    ...
    board_x_win = [[Mark.X, Mark.O, Mark.EMPTY],
                   [Mark.X, Mark.EMPTY, Mark.O],
                   [Mark.X, Mark.EMPTY, Mark.EMPTY]]
    assert _compute_winner(board_x_win) == Mark.X

    board_o_win = [[Mark.X, Mark.O, Mark.X],
...
def test_compute_winner_diag():
    ...
    board_o_win = [[Mark.EMPTY, Mark.EMPTY, Mark.O],
...
def test_board_from_string():
    ...
    expected_board = [[Mark.X, Mark.EMPTY, Mark.O],
                      [Mark.O, Mark.X, Mark.EMPTY],
                      [Mark.EMPTY, Mark.O, Mark.X]]
...
def test_board_to_string_from_string_roundtrip():
    ...
    original_board = [[Mark.X, Mark.EMPTY, Mark.O],
                      [Mark.O, Mark.X, Mark.EMPTY],
                      [Mark.EMPTY, Mark.O, Mark.X]]
...
def test_heuristic_value_o_won_for_o():
    ...
    state = GameState(
        board=[[Mark.O, Mark.EMPTY, Mark.EMPTY],
               [Mark.X, Mark.X, Mark.EMPTY],
               [Mark.O, Mark.X, Mark.O]],
        next_player=Mark.X,
